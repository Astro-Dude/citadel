...
class IncidentAction(Action):
    ...
    + governance-specific arguments. When the action goes through the
    council, the env wraps this into a CommanderProposal first, submits
    to Oversight, and then applies the (possibly revised) action.
    """
    action: int = Field(
        ..., ge=0, lt=NUM_ACTIONS,
...
class IncidentState(State):
    ...
    adversary_gen: int = Field(default=1, ge=1, le=3,
        description="Adversary generation this episode (1/2/3).")
