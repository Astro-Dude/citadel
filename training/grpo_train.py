...
def train_commander():
    ...
    config = GRPOConfig(
        ...
        learning_rate=5e-6,
        num_generations=8,          # more rollouts → better reward variance for GRPO
        max_completion_length=512,  # was 300 — model was truncating at ~60 tokens
        temperature=1.0,            # was 0.7 — higher diversity prevents identical rollouts
        logging_steps=5,
